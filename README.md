...
| 🦀 **Robin Engine** | [robin-sparkless](https://github.com/eddiethedean/robin-sparkless) (0.12.0) directly wired to Python via PyO3; single extension, no extra engine layer |
...
- 🦀 **Robin 0.12.0** – Logical plans are translated and executed by the crate
...
*Dataset: 10k rows (id, x, key, value). All queries run on robin-sparkless 0.12.0. Full suite: `pytest -n 12`.*
...
- 🦀 **Single engine** – Execution is entirely via the [robin-sparkless](https://github.com/eddiethedean/robin-sparkless) Rust crate (0.12.0), integrated with PyO3. No backend selection; no Polars or other Python execution backends.
