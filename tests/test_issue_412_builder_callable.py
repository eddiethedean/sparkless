...
class TestIssue412BuilderCallable:
    ...
    def test_builder_callable_returns_self(self) -> None:
        ...
        builder_from_property = SparkSession.builder
        builder_from_call = SparkSession.builder()
    ...
    def test_builder_property_and_call_equivalent(self) -> None:
        ...
        spark1 = SparkSession.builder.appName("prop_form").getOrCreate()
        spark1.stop()
        SparkSession._singleton_session = None

        spark2 = SparkSession.builder().appName("call_form").getOrCreate()
        try:
